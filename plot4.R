...
par(mfrow=c(2,2),mar=c(4,4,2,1), cex=0.7, cex.lab=1)
...
with(DT2,legend("topright",lwd=1,bty="n",col=c("black","red","blue"),legend=c("Sub_metering_1","Sub_metering_2","Sub_metering_3")))
